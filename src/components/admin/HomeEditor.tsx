        ...
        >
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-3">
            ...
            <ImageRows
              ...
              addLabel="Добавить фотографию"
              aspect={1}
              hint="От 1 до 16 фотографий, сетка сама подбирает раскладку без пустых мест: при нечётном числе одна-две плитки становятся крупнее. Пока фото нет, показываются четыре заглушки. При прокрутке до блока плитки появляются одна за другой."
