        ...
        >
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-3">
            ...
            <TitleTextRows
              ...
              rows={4}
              hint="От 1 до 16 объектов, сетка сама подбирает раскладку без пустых мест. Заголовок — название здания, оно подписано внизу фото. Текст — полное описание, открывается в окне по клику; если текста нет, в окне будет только название. Пока фото нет, показываются заглушки."
              iconGroup="groupPhotos"
              iconLabel="Фото объекта"
              iconHint="Квадратный кадр. После выбора файла можно вырезать нужный кусок."
              iconAspect={1}
            />
          </div>
        </Block>
